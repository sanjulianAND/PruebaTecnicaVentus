...
public interface IAutorRepository
{
    ...
    Task<(IEnumerable<Autor> Items, int Total)> GetPaginadoAsync(int pagina, int tamanoPagina, string? ordenarPor, bool ordenDescendente, CancellationToken cancellationToken = default);
